        ...
        <aside class="admin-sidebar" id="admin-sidebar">
            ...
            <div class="admin-brand">
                ...
                <a href="{{ route('admin.dashboard') }}">
                    ...
                    <img src="{{ asset('images/collectinfo-logo.jpg') }}" alt="Collectinfos" class="admin-brand-logo">
            ...
            <nav class="admin-nav">
                ...
                <a href="{{ route('admin.press-requests.index') }}" @class(['active' => request()->routeIs('admin.press-requests.*')])>

                    <i class="fa-solid fa-file-lines" aria-hidden="true"></i> Demandes presse
