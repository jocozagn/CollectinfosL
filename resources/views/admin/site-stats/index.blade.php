...
@section('content')
    <div class="admin-panel">
        <div class="panel-header">
            ...
            <a href="{{ route('admin.site-stats.create') }}" class="btn btn-primary">
                ...
                <tbody>
                    @foreach ($stats as $item)
                        <tr>
                            ...
                            <td class="actions">
                                <a href="{{ route('admin.site-stats.edit', $item) }}" class="btn btn-sm"><i class="fa-solid fa-pen" aria-hidden="true"></i></a>
